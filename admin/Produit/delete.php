<?php
    ...
    if(!empty($_POST)) {
        ...
        $reponse = $db->prepare('SELECT Imgsrc FROM produit WHERE NumProd = ?');
        $reponse->execute(array($id));
        $donnees = $reponse->fetch();
        unlink('../../Images/' . $donnees['Imgsrc']);
         ...
         <div class="container admin">
            <div class="row">
                ...
                <form class="form" action="delete.php" role="form" method="post">
                    ...
                    <p class="alert alert-warning">Etes vous sur de vouloir supprimer <?php echo $id;?> ?</p>
