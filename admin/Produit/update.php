<?php
    ...
    if(!empty($_POST)) 
    {
        ...
        { 
            ...
            if($isImageUpdated)
            {
                $statement = $db->prepare("UPDATE produit  set NomProd = ?, Caracteristiques = ?, PrixProd = ?, NumCat = ?, Imgsrc = ? WHERE NumProd = ?");
                $statement->execute(array($name,$description,$price,$category,$image,$id));
            }
            else
            {
                $statement = $db->prepare("UPDATE produit  set NomProd = ?, Caracteristiques = ?, PrixProd = ?, NumCat = ? WHERE NumProd = ?");
        ...
        {
            $db = Database::connect();
            $statement = $db->prepare("SELECT * FROM produit where NumProd = ?");
    ...
    else 
    {
        ...
        $item = $statement->fetch();
        $name           = $item['NomProd'];
        $description    = $item['Caracteristiques'];
        $price          = $item['PrixProd'];
                ...
                <div class="col-sm-6">
                    ...
                    <form class="form" action="<?php echo 'update.php?id='.$id;?>" role="form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input style="height:100px;" type="text" class="form-control" id="description" name="description" placeholder="Description" value="<?php echo $description;?>">
